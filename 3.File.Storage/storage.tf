  ...
  storageAccounts = [
    for storageAccount in var.storageAccounts : merge(storageAccount, {
      resourceGroup = {
        ...
        location = storageAccount.extendedZone.enable && var.virtualNetwork.extendedZone.enable ? var.virtualNetwork.extendedZone.location : data.azurerm_virtual_network.main.location
      }
      extendedZone = {
        name = storageAccount.extendedZone.enable && var.virtualNetwork.extendedZone.enable ? var.virtualNetwork.extendedZone.name : null
      }
      storageAccount = {
