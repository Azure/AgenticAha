...
resource azapi_resource linux {
  for_each = {
    for imageTemplate in var.imageBuilder.templates : imageTemplate.name => imageTemplate if (imageTemplate.enable && strcontains(lower(imageTemplate.source.imageDefinition.name), "lnx")) && var.imageBuilder.enable
  }
    ...
    properties = {
      ...
      customize = concat(
        [
          {
            type        = "File"
            sourceUri   = "https://raw.githubusercontent.com/Azure/AgenticAha/main/2.Image/functions.sh"
            destination = "/tmp/functions.sh"
          },
          {
            type        = "File"
            sourceUri   = "https://raw.githubusercontent.com/Azure/AgenticAha/main/2.Image/Linux/customize.sh"
    ...
    properties = {
      ...
      customize = concat(
        [
          {
            type        = "File"
            sourceUri   = "https://raw.githubusercontent.com/Azure/AgenticAha/main/2.Image/functions.ps1"
            destination = "C:\\AzureData\\functions.ps1"
          },
          {
            type        = "File"
            sourceUri   = "https://raw.githubusercontent.com/Azure/AgenticAha/main/2.Image/Windows/customize.ps1"
