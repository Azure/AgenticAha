...
# ################################################################################################################################
# # VPN Gateway Local Network Gateway (https://learn.microsoft.com/azure/vpn-gateway/vpn-gateway-about-vpn-gateway-settings#lng) #
# ################################################################################################################################
...
resource azurerm_local_network_gateway vpn {
  ...
  gateway_fqdn        = var.vpnGatewayLocal.fqdn != "" ? var.vpnGatewayLocal.fqdn : null
  gateway_address     = var.vpnGatewayLocal.address != "" ? var.vpnGatewayLocal.address : null
